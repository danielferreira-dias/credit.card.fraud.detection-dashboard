    ...
    return (
        <div className="flex flex-col w-full h-full mt-6 gap-y-4 items-center sm:items-start">
            ...
            <div className="flex flex-row justify-between items-stretch w-full gap-x-4">
                <div className="flex sm:flex-row  items-center h-full w-fit md:w-fit gap-y-4 rounded-xl flex-wrap" style={{ boxShadow: 'var(--shadow-s)' }}>
                ...
                <div className="relative h-fit xl:h-full rounded-xl items-center" style={{ boxShadow: 'var(--shadow-s)' }}>
