...
export default function Navbar(){
    ...
    return (
        ...
        <div className={`${isCollapsed ? "lg:w-20 " : "lg:w-[17.5%]"} } w-20 h-svh  top-0  max-[500px]:w-full max-[500px]:rounded-none max-[500px]:border-0  max-[500px]:fixed max-[500px]:z-50 ${!isMobileOpen ? "max-[500px]:hidden" : ""} h-[98vh] bg-[#0F0F11] flex flex-col rounded-xl p-2 items-center sticky transition-all duration-300 ease-in-out`} style={{ boxShadow: 'var(--shadow-l)' }}>
