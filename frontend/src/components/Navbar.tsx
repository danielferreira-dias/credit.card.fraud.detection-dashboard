...
export default function Navbar(){
    ...
    return (
        ...
        <div className={`${isCollapsed ? "lg:w-20 " : "lg:w-[17.5%]"} border-[1px] ${isMobileOpen ? "top-0" : "top-0"}  border-zinc-700 w-20 h-svh top-0 max-[500px]:w-full max-[500px]:fixed max-[500px]:z-50 ${!isMobileOpen ? "max-[500px]:hidden" : ""} h-[98vh]  bg-[#0F0F11] flex flex-col border-1 rounded-xl  border-[#2A2A2A] p-2 items-center sticky  transition-all duration-300 ease-in-out`}>
