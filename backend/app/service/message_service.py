...
async def websocket_conversation_handle(conversation_service: ConversationService, current_conversation_id : int | None, user_id : int, title: str | None ) -> tuple[int, str]:
